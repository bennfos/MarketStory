        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientPageUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoryBoards_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestampe = table.Column<DateTime>(nullable: false, defaultValueSql: "GETDATE()"),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ClientPageId", "UserId" },
                values: new object[] { 1, 1, "00000000-ffff-ffff-ffff-ffffffffffff" });

            migrationBuilder.InsertData(
                table: "ClientPageUsers",
                columns: new[] { "Id", "ClientPageId", "UserId" },
                values: new object[] { 2, 2, "00000000-ffff-ffff-ffff-ffffffffffff" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPageEvents_EventId",
                table: "ClientPageEvents",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientPageUsers_ClientPageId",
                table: "ClientPageUsers",
                column: "ClientPageId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientPageUsers_UserId",
                table: "ClientPageUsers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoryBoards_ClientPageId",
                table: "StoryBoards",
                column: "ClientPageId");

            migrationBuilder.CreateIndex(
                name: "IX_StoryBoards_UserId",
                table: "StoryBoards",
                column: "UserId");
